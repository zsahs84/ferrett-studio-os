...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.LYRIA_GENRE_META = {
        ...
        'Math Rock': { category: 'ROCK', bpm: [130, 180], mood: 'intricate, angular, technical, propulsive', texture: 'tapped/interlocking clean guitars, odd time signatures, syncopated bass', vox: 'primarily instrumental; when present, vocals sit low and understated behind the interplay', desc: 'Technically demanding rock built on odd time signatures, interlocking guitar lines, and rhythmic complexity for its own sake. Guitars are clean or lightly overdriven, playing rapid tapped or picked arpeggios that lock together in shifting meters (5/8, 7/8, 11/8). The rhythm section is the star: basslines are melodic and independent rather than root-following, drums are hyper-syncopated and precise. Vocals, when present, are secondary to the instrumental interplay — many tracks are fully instrumental.' },
        'Midwest Emo': { category: 'ROCK', bpm: [100, 140], mood: 'nostalgic, earnest, bittersweet, introspective', texture: 'twinkly clean-tone guitars, open/alternate tunings, understated rhythm section', vox: 'conversational, vulnerable vocal that cracks and strains at emotional peaks, half-sung and half-spoken', desc: 'Rooted in 90s Midwest scenes (American Football, Cap\'n Jazz), this genre pairs the "twinkly" clean-tone guitar sound — compressed Telecasters picked in open or alternate tunings — with plainspoken, diary-entry lyricism. Production favors warmth and space over polish; drums are loose and understated, bass is melodic rather than root-driven, and the emotional weight lives in the vocal delivery cracking on a chorus rather than in volume or distortion.' },
        '2000s Post-Hardcore / Emo-Pop': { category: 'ROCK', bpm: [130, 165], mood: 'melodramatic, urgent, cathartic, polished-angst', texture: 'drop-tuned crunch riffs, gang vocals, big radio-rock builds', vox: 'trade-off between a clean, hooky pop-punk lead and a harsh screamed low-register counter-vocal, often doubling the same line', desc: 'Mid-2000s Warped Tour-era emo (Hawthorne Heights, Silverstein, Story of the Year) pairing thick, drop-tuned post-hardcore guitar crunch with unapologetically polished pop songwriting. The signature move is the vocal trade-off: a clean, melodic lead sings the hook while a second screamed vocal answers it in the low register. Drums are tight and heavily gated for arena-scale punch, guitars are scooped and saturated rather than clean, and the mix chases maximum radio drama over lo-fi authenticity — the opposite instinct from Midwest Emo\'s understatement.' },
        ...
        'Industrial Dream State': { category: 'METAL', bpm: [120, 165], mood: 'cathartic, chaotic yet melodic, emotionally raw beneath a cold digital sheen', texture: 'wall-of-sound distorted guitars widened with chorus, cold synthetic pads, industrial digital texture', vox: 'female vocal swinging between ethereal, melancholic clean singing and harsh fry screams/growls in a stark loud-quiet-loud dynamic', desc: 'A fusion of female-fronted post-hardcore, alternative metal, and screamo underpinned by industrial rock production, built around the "loud-quiet-loud" dynamic: intimate, ethereal clean singing torn apart by aggressive fry screams and growls, reflecting a conflict between public face and private turmoil. Guitars are heavily multi-tracked, hard-panned, and high-gain, run through chorus and spatial modulation for a wide, disorienting wall of sound. Bass is palm-muted and relentless, locking with fast double-kick patterns and syncopated, nervous grooves that keep the rhythm feeling unstable rather than stagnant. Cold, ambient synthetic pads and digital textures thread through intros and bridges, deliberately sterile and eerie against the warmth of the vocals — a "digital prison" atmosphere standing in for themes of social isolation and the struggle for authenticity in a digital-dominated world. Sonic comps: Dream State, As Everything Unfolds, Vukovi, Blood Command, Brutus.' },
    ...
    window.runLyriaGenerate = async () => {
        ...
        try {
            ...
            const sys = [
                ...
                'MOOD and TEXTURE can both use tonal/temperature words ("warm", "cool", "dark", "bright", "cold", "icy") but they mean different things. In MOOD they describe the actual scene as intended — e.g. "warm summer night, top down" IS a real sun-warmed evening feel, take it literally. In TEXTURE they describe the SOUND\'s harmonic color only (tape/tube warmth, EQ tilt, sub weight — e.g. "warm acoustic guitar") and must NEVER be read as weather, daylight or time-of-day on their own. If TEXTURE says "warm" but MOOD is nocturnal, dark or wintry, trust MOOD for the scene — a warm-toned guitar in a cold winter night song stays a cold winter night; do not invent sunlight or golden-hour imagery to reconcile the two.'
            ].filter(Boolean).join(' ');
            const roleLines = [
    ...
    window.runProducerNotesGenerate = async () => {
        ...
        try {
            const sys = [
                ...
                'This genre\'s MOOD and TEXTURE can both use tonal/temperature words ("warm", "cool", "dark", "bright", "cold", "icy") but they mean different things. In MOOD they describe the actual scene as intended — e.g. "warm summer night, top down" IS a real sun-warmed evening feel, take it literally. In TEXTURE they describe the SOUND\'s harmonic color only (tape/tube warmth, EQ tilt, sub weight — e.g. "warm acoustic guitar") and must NEVER be read as weather, daylight or time-of-day on their own. If TEXTURE says "warm" but MOOD is nocturnal, dark or wintry, trust MOOD for the scene — a warm-toned instrument in a cold winter night genre stays a cold winter night; do not invent sunlight or golden-hour imagery to reconcile the two.'
            ].join(' ');
            const meta = window.getGenreMeta(genre);
