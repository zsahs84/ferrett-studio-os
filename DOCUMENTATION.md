...
- **Integrated Rhyming Dictionary:** Double-click any word (or type it in the search box) to instantly pull up near-rhymes, exact rhymes, and synonyms via the Datamuse API, without ever leaving the page.
